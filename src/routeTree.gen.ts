...
const AuthenticatedSettingsLaunchersRoute =
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/settings/scan-roots': {
      ...
      path: '/scan-roots'
      fullPath: '/settings/scan-roots'
      preLoaderRoute: typeof AuthenticatedSettingsScanRootsRouteImport
      parentRoute: typeof AuthenticatedSettingsRouteRoute
    }
    '/_authenticated/settings/launchers': {
      id: '/_authenticated/settings/launchers'
      path: '/launchers'
      fullPath: '/settings/launchers'
